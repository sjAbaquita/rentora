...
import { DocumentType, getValidationErrors } from '@/types/domains';
...
const submit = async () => {
    ...
    try {
        await documentService.create(formData.value);
...
<template>
    ...
    <div class="space-y-6 p-4 md:p-6">
        <section class="flex flex-col gap-4 rounded-3xl border border-sidebar-border/70 bg-background p-6 shadow-sm lg:flex-row lg:items-end lg:justify-between">
            <div><h1 class="text-3xl font-semibold">Document</h1></div>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    <div class="grid gap-6 md:grid-cols-2">
                        ...
                        <div class="col-span-2 space-y-2">
                            ...
                            <Input id="description" v-model="formData.description" type="text" :disabled="loading" />
                        </div>
                    </div>
